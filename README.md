...
<details>
<summary><strong> ⚡ What I Bring to the Table </strong></summary>
<br>

* **Distributed Systems:** Experience building high-throughput, fault-tolerant applications and working with asynchronous pipelines.
* **Full-Stack Mentality:** Comfortable jumping between optimizing heavy database queries and building out user-facing APIs.
* **Data-Driven Engineering:** Leveraging my background in data science to build smarter, data-aware backend systems. 
